...
const I18N = {
  vi: {
    ...
    addEntry: "Ghi một khoản mới", expense: "Chi tiêu", income: "Thu nhập", saving: "Tiết kiệm",
    ...
    ledger: "Sổ chi tiêu", clearAll: "Xóa hết", searchPh: "Tìm theo ghi chú...",
    ...
    exportBtn: "Xuất dữ liệu (.json)", importBtn: "Nhập dữ liệu từ file", resetBtn: "Xóa toàn bộ & cài đặt lại",
    scoldSum: "Câu mắng tự viết",
    ...
    charNote: "Tự tạo nhân vật với tên, biểu tượng và câu thoại riêng. Mỗi dòng là một câu.",
    ...
    downloadImg: "Tải ảnh", copyCap: "Copy caption",
    editTitle: "Sửa khoản này", essential: "Thiết yếu?", essNoShort: "Không", essYesShort: "Có",
    editSave: "Lưu thay đổi", share: "Chia sẻ", copy: "Copy",
    onboardSkip: "Bỏ qua", onboardNext: "Tiếp →", onboardStart: "Bắt đầu",
    settingsTitle: "Cài đặt", settingsOpen: "Cài đặt & tùy chỉnh →",
  ...
  en: {
    ...
    addEntry: "Add a new entry", expense: "Expense", income: "Income", saving: "Saving",
    ...
    ledger: "Transactions", clearAll: "Clear all", searchPh: "Search by note...",
    ...
    exportBtn: "Export data (.json)", importBtn: "Import from file", resetBtn: "Erase everything & reset",
    scoldSum: "Your own scoldings",
    ...
    charNote: "Make a character with a name, symbol and lines. One line per row.",
    ...
    downloadImg: "Save image", copyCap: "Copy caption",
    editTitle: "Edit this entry", essential: "Essential?", essNoShort: "No", essYesShort: "Yes",
    editSave: "Save changes", share: "Share", copy: "Copy",
    onboardSkip: "Skip", onboardNext: "Next →", onboardStart: "Start",
    settingsTitle: "Settings", settingsOpen: "Settings & customization →",
